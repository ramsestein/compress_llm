...
class TestCompressionMethodsSpecific(unittest.TestCase):
    ...
    def test_int8_quantization(self):
        ...
        config = {"strength": 0.5, "bits": 8, "symmetric": True}
        ...
        # Verify que los pesos están cuantizados
        if hasattr(compressed, "weight"):
            weight = compressed.weight.data
            # Verify que los valores están en rango INT8
    ...
    def test_int4_quantization(self):
        ...
        config = {"strength": 0.7, "bits": 4, "symmetric": False}
    ...
    def test_int2_quantization(self):
        ...
        config = {"strength": 0.8, "bits": 2, "ternary": True}
        ...
        # Verify que se aplicó la compresión INT2
        if hasattr(compressed, "weight"):
            weight = compressed.weight.data
            # Verify que los pesos no son NaN o infinitos
            self.assertFalse(torch.isnan(weight).any())
            self.assertFalse(torch.isinf(weight).any())
            # Verify que los pesos están en un rango razonable para INT2
    ...
    def test_magnitude_pruning(self):
        ...
        config = {"strength": 0.3, "pruning_type": "magnitude", "sparsity": 0.3}
    ...
    def test_structured_pruning(self):
        ...
        config = {"strength": 0.4, "pruning_type": "structured", "sparsity": 0.4, "block_size": 4}
    ...
    def test_attention_pruning(self):
        ...
        config = {"strength": 0.5, "head_sparsity": 0.3, "attention_type": "self_attention"}
    ...
    def test_svd_decomposition(self):
        ...
        config = {"strength": 0.6, "rank": 50, "svd_type": "truncated"}
        ...
        # Verify que se aplicó SVD
        if hasattr(compressed, "weight"):
            weight = compressed.weight.data
            # Verify que la matriz tiene rango reducido
    ...
    def test_tucker_decomposition(self):
        ...
        config = {"strength": 0.5, "ranks": [10, 25], "tucker_type": "standard"}
    ...
    def test_mpo_compression(self):
        ...
        try:
            ...
            config = {"strength": 0.4, "bond_dim": 8, "mpo_type": "standard"}
    ...
    def test_low_rank_approximation(self):
        ...
        config = {"strength": 0.5, "rank": 30, "approximation_type": "svd"}
    ...
    def test_expert_pruning(self):
        ...
        config = {"strength": 0.3, "expert_sparsity": 0.3, "num_experts": 8}
    ...
    def test_mixed_precision_method(self):
        ...
        config = {"strength": 0.5, "precision_levels": ["fp16", "fp32"], "mixed_type": "dynamic"}
    ...
    def test_block_sparse_method(self):
        ...
        config = {"strength": 0.4, "block_size": 4, "sparsity": 0.4, "sparse_type": "structured"}
    ...
    def test_compression_estimation(self):
        """Test of estimación de compresión para todos los métodos."""
        methods = [
        ...
        for method in methods:
            ...
            # Verify que la estimación es válida
    ...
    def test_engine_with_all_methods(self):
        """Test of integración con todos los métodos en el engine."""
        methods_config = {
        ...
        for method_name, config in methods_config.items():
            # Create configuración completa
            full_config = {"methods": [{"name": method_name, **config}], "target_compression": 0.5}
    ...
    def test_invalid_configurations(self):
        ...
        invalid_config = {"strength": 1.5, "bits": 16}  # Strength > 1  # Bits no soportados
