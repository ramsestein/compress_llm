...
class TestPEFTMethodsConfig(unittest.TestCase):
    ...
    def test_peft_method_enum(self):
        ...
        # Verify que todos los métodos están definidos
        expected_methods = [
            "lora",
            "molora",
            "galore",
    ...
    def test_lora_config(self):
        ...
        # Verify valores específicos de LoRA
        self.assertEqual(config.method, PEFTMethod.LORA)
    ...
    def test_molora_config(self):
        ...
        # Verify valores específicos de MoLoRA
        ...
        # Verify post_init con valores por defecto
    ...
    def test_galore_config(self):
        ...
        # Verify valores específicos de GaLore
    ...
    def test_dora_config(self):
        ...
        # Verify valores específicos de DoRA
    ...
    def test_bitfit_config(self):
        ...
        # Verify valores específicos de BitFit
    ...
    def test_ia3_config(self):
        ...
        # Verify valores específicos de IA3
    ...
    def test_prompt_tuning_config(self):
        ...
        # Verify valores específicos de Prompt Tuning
    ...
    def test_adapter_config(self):
        ...
        # Verify valores específicos de Adapter
    ...
    def test_qlora_config(self):
        ...
        # Verify valores específicos de QLoRA
    ...
    def test_peft_presets(self):
        ...
        # Verify que todos los presets están definidos
        ...
        # Verify que las configuraciones tienen el método correcto
    ...
    def test_estimate_memory_usage(self):
        ...
        # Verify que la memoria PEFT es menor que la del modelo
        self.assertLess(
            memory_estimate["peft_memory_mb"], memory_estimate["model_memory_gb"] * 1024
        )
    ...
    def test_config_serialization(self):
        ...
        config = LoRAConfig(
            method=PEFTMethod.LORA, r=16, lora_alpha=32, target_modules=["attn.c_attn"]
        )
