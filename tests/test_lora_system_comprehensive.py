...
from LoRa_train.lora_config import (
    LoRAConfig as LoRALegacyConfig,
)
...
class TestLoRASystemComprehensive(unittest.TestCase):
    ...
    def test_lora_config_initialization(self):
        """Test of inicialización de configuración LoRA."""
    ...
    def test_lora_config_customization(self):
        """Test of personalización de configuración LoRA."""
        config = LoRAConfig(
    ...
    def test_lora_config_serialization(self):
        """Test of serialización de configuración LoRA."""
    ...
    def test_training_config_initialization(self):
        """Test of inicialización de configuración de entrenamiento."""
    ...
    def test_training_config_customization(self):
        """Test of personalización de configuración de entrenamiento."""
        config = TrainingConfig(
            num_train_epochs=5,
    ...
    def test_data_config_initialization(self):
        """Test of inicialización de configuración de datos."""
        config = DataConfig()
    ...
    def test_data_config_customization(self):
        """Test of personalización de configuración de datos."""
        config = DataConfig(
            max_length=256,
            truncation=False,
            padding="longest",
    ...
    def test_lora_presets_structure(self):
        """Test of estructura de presets LoRA."""
        # Verify que existen los presets principales
    ...
    def test_balanced_preset(self):
        """Test ofl preset balanceado."""
        preset = LoRAPresets.get_preset("balanced")

        # Verify configuración LoRA
        ...
        # Verify configuración de entrenamiento
    ...
    def test_fast_preset(self):
        """Test ofl preset conservativo (equivalente a fast)."""
    ...
    def test_quality_preset(self):
        """Test ofl preset agresivo (equivalente a quality)."""
    ...
    def test_model_specific_configs(self):
        """Test of configuraciones específicas por modelo."""
        # Test GPT2
    ...
    def test_unknown_model_config(self):
        """Test of configuración para modelo desconocido."""
    ...
    def test_molora_linear_initialization(self):
        """Test of inicialización de MoLoRALinear."""
        config = MoLoRAConfig(
    ...
    def test_molora_forward_pass(self):
        """Test of forward pass de MoLoRALinear."""
        config = MoLoRAConfig(
            method=PEFTMethod.MOLORA, num_experts=2, expert_r=[4, 4], expert_alpha=[8, 8]
        )
    ...
    def test_dora_linear_initialization(self):
        """Test of inicialización de DoRALinear."""
        config = DoRAConfig(method=PEFTMethod.DORA, r=8, lora_alpha=16)
    ...
    def test_dora_forward_pass(self):
        """Test of forward pass de DoRALinear."""
        config = DoRAConfig(method=PEFTMethod.DORA, r=4, lora_alpha=8)
    ...
    def test_adapter_linear_initialization(self):
        """Test of inicialización de AdapterLinear."""
        config = AdapterConfig(method=PEFTMethod.ADAPTER, adapter_size=64, adapter_dropout=0.1)
    ...
    def test_adapter_forward_pass(self):
        """Test of forward pass de AdapterLinear."""
        config = AdapterConfig(method=PEFTMethod.ADAPTER, adapter_size=32, adapter_dropout=0.1)
    ...
    def test_get_available_methods(self):
        """Test of obtención de métodos disponibles."""
    ...
    def test_get_available_presets(self):
        """Test of obtención de presets disponibles."""
    ...
    def test_base_peft_config(self):
        """Test of configuración base PEFT."""
        config = BasePEFTConfig(method=PEFTMethod.LORA, target_modules=["q_proj", "v_proj"])
    ...
    def test_dataset_manager_initialization(self):
        """Test of inicialización del gestor de datasets."""
    ...
    def test_dataset_scanning(self):
        ...
        # Verify que encuentra el dataset de prueba
        self.assertIsInstance(datasets, list)
        self.assertGreater(len(datasets), 0)

        # Verify estructura del dataset encontrado
        dataset = datasets[0]
    ...
    def test_dataset_config_creation(self):
        """Test of creación de configuración de dataset."""
        OptimizedDatasetManager(str(self.test_dir))

        # Create configuración de dataset
    ...
    def test_dataset_config_serialization(self):
        """Test of serialización de configuración de dataset."""
        config = DatasetConfig(
            file_path=self.test_dataset_path,
            format="csv",
            columns={"instruction": "instruction", "response": "response"},
    ...
    def test_lora_trainer_initialization(self):
        """Test of inicialización del trainer LoRA."""
        trainer = LoRATrainer(
    ...
    def test_peft_universal_trainer_initialization(self):
        """Test of inicialización del trainer universal PEFT."""
        # Create configuración de prueba
        peft_config = LoRAConfig(method=PEFTMethod.LORA, r=8, lora_alpha=16)
        ...
        # Verify que se inicializó correctamente
        self.assertIsNotNone(trainer)
    ...
    def test_end_to_end_lora_workflow(self):
        """Test of flujo completo de LoRA."""
        ...
        # Create configuración de entrenamiento
        training_config = TrainingConfig(
            num_train_epochs=1, learning_rate=1e-4, per_device_train_batch_size=2
        )

        # Create configuración de datos
        data_config = DataConfig(max_length=256, eval_split_ratio=0.1)

        # Verify configuraciones
    ...
    def test_model_specific_integration(self):
        """Test of integración específica por modelo."""
        # Configuration para GPT2
        gpt2_config = get_model_specific_config("gpt2")
        lora_config = LoRAConfig(
            method=PEFTMethod.LORA,
            r=8,
    ...
    def test_preset_integration(self):
        """Test of integración de presets."""
        # Get preset balanceado
        preset = LoRAPresets.get_preset("balanced")

        # Verify integración de componentes
        self.assertIsInstance(preset["lora"], LoRALegacyConfig)
        self.assertIsInstance(preset["training"], TrainingConfig)
        self.assertIsInstance(preset["data"], DataConfig)
    ...
    def test_dataset_integration(self):
        """Test of integración de datasets."""
        dm = OptimizedDatasetManager(str(self.test_dir))
        datasets = dm.scan_datasets()

        # Verify que el dataset está disponible
        self.assertGreater(len(datasets), 0)
    ...
    def test_peft_methods_integration(self):
        """Test of integración de métodos PEFT."""
    ...
    def test_memory_estimation_integration(self):
        """Test of integración de estimación de memoria."""
        # Configuration LoRA
        lora_config = LoRAPresets.get_preset("balanced")["lora"]

        # Estimar memoria
        memory_usage = LoRAPresets.estimate_memory_usage(
            model_size_gb=1.0, config=lora_config, batch_size=4
        )

        # Verify que la estimación es razonable
        self.assertGreater(memory_usage["total_estimated"], 1.0)
    ...
    def test_error_handling(self):
        """Test of manejo de errores."""
        # Test con configuración inválida
        try:
            LoRAConfig(method=PEFTMethod.LORA, r=-1)  # r inválido
    ...
    def test_numerical_stability(self):
        ...
        # Verify que la configuración es válida
    ...
    def test_reproducibility(self):
        """Test of reproducibilidad."""
        # Create dos configuraciones idénticas
