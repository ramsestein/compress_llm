...
class TestPEFTUniversalTrainer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create archivos mock del modelo
        self._create_mock_model_files()

        # Configuration for prueba
    ...
    def _setup_mock_tokenizer(self, mock_tokenizer_instance):
        ...
        # Create un objeto real que pueda ser subscriptado
        class MockEncoded:
            def __init__(self):
    ...
    def test_lora_training(self, mock_get_peft_model, mock_tokenizer, mock_model):
        ...
        with patch.object(trainer, "_setup_training"), patch.object(
            ...
            # Verify que se llamó get_peft_model
    ...
    def test_dataset_preparation(self):
        ...
        # Test of preparación de datasets
