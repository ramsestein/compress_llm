...
class OptimizedReportGenerator:
    ...
    def generate_compression_report(self,
                                  ...
                                  format: str = 'html') -> Path:
        """Genera reporte de compresión con resultados"""
    ...
    def _process_layer_summary(self, summary: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Procesa resumen de capas para visualización"""
        processed = []
    ...
    def _process_layer_changes(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Procesa cambios en las capas por compresión"""
    ...
    def _generate_analysis_visualizations(self, data: Dict[str, Any]) -> Dict[str, str]:
        ...
        if layer_summary:
            ...
            ax.set_title('Distribución de Tamaños por Tipo de Capa')
    ...
    def _generate_compression_visualizations(self, data: Dict[str, Any]) -> Dict[str, str]:
        ...
        if size_data:
            ...
            ax1.set_title('Comparación de Tamaños')
            ...
            if methods:
                ...
                ax2.set_title('Métodos de Compresión Utilizados')
...
<body>
    ...
    def _generate_analysis_html_content(self, data: Dict[str, Any], 
        ...
        <div class="section">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
                ...
                <div class="metric">
                    ...
                    <div class="metric-label">Tamaño del Modelo</div>
                </div>
                <div class="metric">
        ...
        if recs:
            sections.append(f"""
            <div class="section">
                <h2>💡 Recomendaciones de Compresión</h2>
        ...
        <div class="section">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
                ...
                <div class="metric">
                    ...
                    <div class="metric-label">Tamaño Original</div>
                </div>
                <div class="metric">
                    <div class="metric-value">{size_red.get('compressed_mb', 0):.1f} MB</div>
                    <div class="metric-label">Tamaño Comprimido</div>
                </div>
            </div>
        </div>
        """)
    ...
    def _generate_analysis_markdown(self, data: Dict[str, Any]) -> List[str]:
        ...
        lines.extend([
            "## 📊 Estadísticas del Modelo",
            f"- **Parámetros totales:** {stats.get('total_parameters', 0):,}",
            f"- **Tamaño:** {stats.get('total_size_gb', 0):.2f} GB",
            f"- **Tiempo de análisis:** {data.get('metadata', {}).get('analysis_time', 0):.1f}s",
            ""
        ])
        
        # Distribución de capas
        lines.append("## 📈 Distribución por Tipo de Capa\n")
        lines.append("| Tipo | Capas | Tamaño (MB) | % del Modelo |")
        lines.append("|------|-------|-------------|--------------|")
    ...
    def _generate_compression_markdown(self, data: Dict[str, Any]) -> List[str]:
        ...
        lines.extend([
            ...
            f"- **Tamaño original:** {size_red.get('original_mb', 0):.1f} MB",
            f"- **Tamaño comprimido:** {size_red.get('compressed_mb', 0):.1f} MB",
        ...
        if methods:
            lines.extend([
                "## 🔧 Métodos de Compresión Utilizados",
...
def generate_quick_summary(data: Dict[str, Any]) -> str:
    ...
    summary_lines = [
        ...
        f"Tamaño: {data.get('size_mb', 0):.1f} MB",
