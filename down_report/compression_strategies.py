"""Compression strategies para diferentes casos de uso."""
...
class CompressionMethod:
    """Method de compresión con configuración."""
...
class CompressionStrategies:
    ...
    def _create_strategy(
        self, name: str, description: str, compression_map: Dict, expected_performance: float
    ) -> Dict:
        ...
        for layer_name, profile in self.layer_profiles.items():
            compression_ratio = self._get_compression_ratio(profile, compression_map)
