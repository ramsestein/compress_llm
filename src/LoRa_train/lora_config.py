...
class LoRAConfig:
    ...
    # Parameters básicos de LoRA
    r: int = 16  # Rank de las matrices
    lora_alpha: int = 32  # Parámetro de escalado
    lora_dropout: float = 0.1  # Dropout para LoRA
    bias: str = "none"  # none, all, lora_only
    task_type: str = "CAUSAL_LM"  # Type de tarea

    # Target modules (qué layers adaptar)
...
class TrainingConfig:
    """Configuration for entrenamiento."""
...
class LoRAPresets:
    ...
    def get_preset(preset_name: str) -> Dict[str, Any]:
        ...
        presets = {
            ...
            "balanced": {
                ...
                "training": TrainingConfig(
                    num_train_epochs=3, learning_rate=2e-4, per_device_train_batch_size=4
                ),
                "data": DataConfig(),
            },
            "aggressive": {
            ...
            "healing": {
                ...
                "data": DataConfig(max_length=256),
            },
        }
    ...
    def estimate_memory_usage(
        model_size_gb: float, config: LoRAConfig, batch_size: int = 4
    ) -> Dict[str, float]:
        """Estima el uso de memoria para el entrenamiento."""
        # Estimación aproximada
        base_model_memory = model_size_gb  # Model base
