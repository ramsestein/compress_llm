"""Profilees de compresión predefinidos y optimizados para diferentes casos de uso."""

from typing import Any, Dict, List, Optional

# Profilees optimizados predefinidos
COMPRESSION_PROFILES = {
    ...
    "balanced": {
        ...
        "layer_configs": {
            ...
            "output": {
                "methods": [{"name": "magnitude_pruning", "strength": 0.2}],
                "total_compression_ratio": 0.15,
            },
            "linear": {
                "methods": [
            ...
            "other": {
                "methods": [{"name": "magnitude_pruning", "strength": 0.4}],
        ...
        "position_modifiers": {
            "early_layers": {
                ...
                "description": "Reducir compresión en layers iniciales",
            },
            "middle_layers": {
                "range": [0.3, 0.7],
            ...
            "late_layers": {
                ...
                "description": "Mayor compresión en layers finales",
            },
        },
        "final_layers_special": True,
        "risk_level": "medium",
    ...
    "aggressive": {
        ...
        "position_modifiers": {
            "early_layers": {
                ...
                "description": "Proteger layers muy iniciales",
            },
            "middle_layers": {
                "range": [0.2, 0.8],
            ...
            "late_layers": {
                ...
                "description": "Máxima compresión en layers finales",
            },
        },
    ...
    "mobile": {
        ...
        "layer_configs": {
            ...
            "embedding": {
                "methods": [{"name": "int8_quantization", "strength": 0.8}],
                "total_compression_ratio": 0.4,
            },
            "output": {
                "methods": [{"name": "int8_quantization", "strength": 0.7}],
                "total_compression_ratio": 0.35,
            },
            "normalization": {
                "methods": [{"name": "none", "strength": 0.0}],
            ...
            "other": {
                "methods": [{"name": "magnitude_pruning", "strength": 0.5}],
                "total_compression_ratio": 0.4,
            },
        },
    ...
    "edge": {
        ...
        "layer_configs": {
            ...
            "other": {
                "methods": [{"name": "magnitude_pruning", "strength": 0.7}],
                "total_compression_ratio": 0.6,
            },
        },
        "final_layers_special": False,
    ...
    "research": {
        ...
        "layer_configs": {
            ...
            "other": {
                "methods": [{"name": "magnitude_pruning", "strength": 0.8}],
                "total_compression_ratio": 0.7,
            },
        },
        "position_modifiers": {
            "early_layers": {
                ...
                "description": "Mínima compresión en primeras layers",
            },
            "middle_layers": {
                "range": [0.1, 0.9],
                "compression_multiplier": 1.2,
...
def create_custom_profile(
    name: str, base_profile: str = "balanced", modifications: Dict[str, Any] = None
) -> Dict[str, Any]:
    """Crea un perfil personalizado basado en uno existente."""
    base = get_profile(base_profile)
    if not base:
        raise ValueError(f"Profile base not found: {base_profile}")

    # Copiar configuración base
    custom = {
        "name": name,
        "description": f"Profile personalizado basado en {base_profile}",
        "goal": base.get("goal", "custom"),
        "target_compression": base.get("target_compression", 0.5),
        "profile": "custom",
        "layer_configs": base.get("layer_configs", {}).copy(),
        "position_modifiers": (
            base.get("position_modifiers", {}).copy() if base.get("position_modifiers") else None
        ),
...
# Recommendations basadas en el tamaño del modelo
def recommend_profile(
    model_size_mb: float, use_case: str = "general", hardware: str = "gpu"
) -> str:
